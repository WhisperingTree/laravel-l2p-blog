    ...
    <tbody>
      @forelse ($categories as $category)
        <tr>
          ...
          <td>
            <form style="text-align:right;" onsubmit="if(confirm('Удалить?')) { return true }else{ return false }" action="{{route('admin.category.destroy', $category)}}" method="POST">
